...
export const pruebasCrearCuenta=()=>{
    ...
    const controlInputsCrear=async(username,nombre,apellido,correo,nCelular,contra,contraA)=>{
        ...
        if(!caracteresEValidos.test(username)){
            Swal.fire("Error","Solo puedes usar estos caracteres especiales (&*()_-.) en el campo usuario y tu nombre de usuario no debe tener espacios en el medio","error");
            return true;
        }
